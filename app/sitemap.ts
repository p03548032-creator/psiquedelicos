...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/noticias`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
        { url: `${BASE_URL}/musica`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
        ...
        { url: `${BASE_URL}/terapia-espana`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
        { url: `${BASE_URL}/terapeutas`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
